pipeline {
    ...
    stages {
        ...
        //         sh "docker run --name nhandinh-mysql -p 3306:3306 --rm --network dev -v nhandinh-mysql-data:/var/lib/mysql -e MYSQL_ROOT_PASSWORD=Elcom@123 -e MYSQL_DATABASE=db_example  -d mysql:8.1 "
        //         sh 'sleep 20'
